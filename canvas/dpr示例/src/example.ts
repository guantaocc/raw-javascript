...
class App {
  ...
  handleMouseDown(e: MouseEvent){
    console.log(e)
    // 简单画一个点
    const pos: IPos = this.viewportToCanvasPosition(e)
    // drawPoint
    this.drawPoint(pos)
  }

  // pos is circle
  inPointPath(pos: IPos){
    this.ctx2d?.rect(0, 0, this.ctx2d.canvas.width, this.ctx2d.canvas.height)
    return this.ctx2d?.isPointInPath(pos.x, pos.y)
  }
